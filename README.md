...
- [R/11_TexasLandOwnership.R](R/11_TexasLandOwnership.R): Produces estimate for percent of land privately owned in Texas from USGS Gap Analysis Project (GAP), 2024, Protected Areas Database of the United States (PAD-US) 4.1 dataset. We were unable to find a suitable citation for commonly used private land percentages in Texas, so this dataset allows us to have a reasonable estimate.
